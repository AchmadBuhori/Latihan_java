...
public class Dashboard extends JFrame{
	...
	private JTextField txtAchmadBuhori;
	private JTextField txtBogor;
	private JTextField textField_3;
	private JTextField txtM;
	private JTextField txtJalanCibanteng;
	private JTextField txtAchmadbhorigmailcom;
	...
	private void initialize() {
		...
		txtAchmadBuhori = new JTextField();
		txtAchmadBuhori.setColumns(10);
		txtAchmadBuhori.setBounds(215, 48, 194, 20);
		panel.add(txtAchmadBuhori);
		...
		txtJalanCibanteng = new JTextField();
		txtJalanCibanteng.setColumns(10);
		txtJalanCibanteng.setBounds(23, 190, 387, 76);
		panel.add(txtJalanCibanteng);
		
		JLabel lblEmail = new JLabel("Email");
		lblEmail.setBounds(25, 292, 68, 14);
		panel.add(lblEmail);
		
		txtAchmadbhorigmailcom = new JTextField();
		txtAchmadbhorigmailcom.setColumns(10);
		txtAchmadbhorigmailcom.setBounds(24, 322, 171, 20);
		panel.add(txtAchmadbhorigmailcom);
