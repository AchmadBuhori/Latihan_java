public class Person {
    ...
    public static void main(String[] args) {
        ...
        myName.setName(name("Achmad Buhori"));
        //Output name
        System.out.println(myName.getName());

        // Objek birthdate
        Person myBirthdate = new Person();
        myBirthdate.setBirthdate(birthdate("10 juli 2002"));
        //output birthdate
        System.out.println(myBirthdate.getBirthdate());

        // Objek department
        Person myDepartment = new Person();
        myDepartment.setDepartment(department("Fakultas Pariwisata dan informatika"));
        // output department
