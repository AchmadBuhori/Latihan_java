...
public class Login extends JFrame {
	...
	private void initialize(JFrame frmLoginPage) {
		...
		labelLogo.setIcon(new ImageIcon("D:\\PBO_S3\\202310064-PBO-PerpusIBIK\\my-library\\src\\main\\java\\com\\ibik\\library\\images\\logo-ibik-web.png"));
		...
		btnSignIn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				} else if (inUser.equalsIgnoreCase("202310064") && inPass.equalsIgnoreCase("10072002")) { // kondisi jika username dan password benar
		...
		JLabel lblNewLabel = new JLabel("(c) 2021 Achmad Buhori");
